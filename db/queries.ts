...
import { challengeOptions, challengeProgress, courses, lessons, units, userProgress, userSubscription } from "@/db/schema";
import { auth } from "@clerk/nextjs";
import CoursePage from "@/app/(main)/courses/page";
