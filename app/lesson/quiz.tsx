...
const [lessonId]=useState(initialLessonId);
    ...
    if(!challenge){
        return (
            ...
            numberOfPieces={500}
            tweenDuration={10000}/>
            <div className="flex flex-col gap-y-4 lg:gap-y-8 max text-center items-center justify-center h-full">
                <Image 
                src="/finish.svg"
                alt="Finish"
    ...
    return (
        <>
            ...
            <Header 
                hearts={hearts}
                percentage={percentage} hasActiveSubscription={!!userSubscription?.isActive}/>
